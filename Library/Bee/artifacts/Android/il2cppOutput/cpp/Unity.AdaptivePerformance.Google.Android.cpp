...
IL_0024:
	{
		__this->___m_PerformanceMode = 0;
		PerformanceDataRecord_tDF1B7607FB8378B49C42DFFA5AE4A64F62C42F83* L_5 = (PerformanceDataRecord_tDF1B7607FB8378B49C42DFFA5AE4A64F62C42F83*)(&__this->___m_Data);
		int32_t L_6;
		L_6 = PerformanceDataRecord_get_PerformanceMode_mEF911B8B3207795B86E013D3DFF2679A599D78DF_inline(L_5, NULL);
		int32_t L_7 = __this->___m_PerformanceMode;
...
IL_0044:
	{
		RuntimeObject* L_9 = __this->___m_DataLock;
		V_2 = L_9;
		V_3 = (bool)0;
	}
	{
...
IL_008e:
		...
		try
		{
			...
			PerformanceDataRecord_set_ChangeFlags_mE99AA127E129C78872D68F5C650D55B8E5D33DC8_inline(L_14, ((int32_t)((int32_t)L_15|((int32_t)4096))), NULL);
			...
			int32_t L_17 = __this->___m_PerformanceMode;
			PerformanceDataRecord_set_PerformanceMode_m60B7287BBD83581603283DEE76151A6B88B4C0BD_inline(L_16, L_17, NULL);
			goto IL_008f;
		}
		catch(Il2CppExceptionWrapper& e)
		{
...
IL_0057_1:
		{
			...
			Version__ctor_m0871675040007535EA3D8083A4BEAE9DF8C92FF4(L_15, ((int32_t)13), 0, NULL);
			bool L_16;
...
CATCH_0071:
	{
		...
		String_t* L_20;
		L_20 = String_Format_mA8DBB4C2516B9723C5A41E6CB1E2FAF4BBE96DD8(((String_t*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&_stringLiteralE5101B38E9F1E9C920BE878A3AC6BA5D346BE84E)), L_19, NULL);
		...
		il2cpp_codegen_runtime_class_init_inline(((RuntimeClass*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&ADPFLog_tCC53A7749CB2C0BB51F81B0AE6B0F83EFF41D8E2_il2cpp_TypeInfo_var)));
		ADPFLog_Debug_m9B0DAABF53FD2AC4E9B4DCC0E5B1E54A10343963(L_20, L_21, NULL);
		IL2CPP_POP_ACTIVE_EXCEPTION(Exception_t*);
		goto IL_008e;
	}
